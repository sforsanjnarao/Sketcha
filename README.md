...
- you might see error in the generate folder inside db/src but ignore it for now. As I didn't exectly get the cause of that error but it'll not stop you to run the code 